...
class ManufacturersControllerTest < ActionController::TestCase
  ...
  test "should create manufacturer" do
    assert_difference('Manufacturer.count') do
      post :create, manufacturer: { image: @manufacturer.image, name: @manufacturer.name, sort_order: @manufacturer.sort_order }
    end
  ...
  test "should update manufacturer" do
    put :update, id: @manufacturer, manufacturer: { image: @manufacturer.image, name: @manufacturer.name, sort_order: @manufacturer.sort_order }
    assert_redirected_to manufacturer_path(assigns(:manufacturer))
  end
